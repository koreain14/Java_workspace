/*자바의 GUI관련 API들은 java.awt 패키지에서 지원한다. 특히 윈도우와 같이
 * 다른 컴포넌트들을 포함할 수 있는 객체는 배치의 문제를 고민해야 하며 */
package gui;
...
public class BorderTest {
	...
	public static void main(String[] args) {
		...
		// Frame에 레이아웃을 적용하자!!
		// 개발자가 레이아웃을 정하지 않으면, 해당객체의 디폴트 배치관리자가 적용되고
		// Frame의 경우 디폴트 배치관리작는  BorderLayout이다! 또한 BorderLayout의 경우
